  ...
  return (
    <>
      {!course.isPublished && (
        <Banner
          variant="warning"
          label="Курс не опубликован. Студенты его не видят"
        />
      )}
        ...
        <div className="grid grid-cols-1 gap-6 mt-16 md:grid-cols-2">
          <div>
            <div className="flex items-center gap-x-2">
              ...
              <h2 className="text-xl">Отредактируйте курс</h2>
            </div>
          ...
          <div className="space-y-6">
            <div>
              <div className="flex items-center gap-x-2">
                ...
                <h2 className="text-xl">Разделы курса</h2>
              </div>
            ...
            <div>
              <div className="flex items-center gap-x-2">
                ...
                <h2 className="text-xl">Стоимость курса</h2>
              </div>
